...
export const members = [
  { id: 'M-00847', name: 'Bush Odonaldi',    status: 'Active',   agency: 'County of Santa Barbara',         tier: 'Safety Tier 1', yearsService: 45, dob: '1959-03-14', gender: 'Male',   maritalStatus: 'Married'  },
  { id: 'M-01203', name: 'Sandra Weaver',    status: 'Retired',  agency: 'County of Santa Barbara',         tier: 'Tier 1',        yearsService: 31, dob: '1950-07-22', gender: 'Female', maritalStatus: 'Widowed'  },
  { id: 'M-02891', name: 'Carlos Reyes',     status: 'Active',   agency: 'County of Santa Barbara',         tier: 'Tier 2',        yearsService: 12, dob: '1988-11-05', gender: 'Male',   maritalStatus: 'Single'   },
  { id: 'M-03405', name: 'Margaret Tran',    status: 'Retired',  agency: 'County of Santa Barbara',         tier: 'Tier 1',        yearsService: 28, dob: '1953-04-18', gender: 'Female', maritalStatus: 'Married'  },
  { id: 'M-04112', name: 'James Okonkwo',    status: 'Active',   agency: 'Carpinteria-Summerland Fire',     tier: 'Safety Tier 1', yearsService: 19, dob: '1972-09-30', gender: 'Male',   maritalStatus: 'Married'  },
  { id: 'M-04788', name: 'Patricia Lin',     status: 'Deferred', agency: 'County of Santa Barbara',         tier: 'Tier 2',        yearsService: 7,  dob: '1992-02-14', gender: 'Female', maritalStatus: 'Single'   },
  { id: 'M-05234', name: 'Robert Ashby',     status: 'Survivor', agency: 'County of Santa Barbara',         tier: 'Tier 1',        yearsService: null, dob: '1945-06-08', gender: 'Male', maritalStatus: 'Widowed'  },
  { id: 'M-05901', name: 'Diana Castillo',   status: 'Active',   agency: 'Goleta Cemetery District',        tier: 'Tier 2',        yearsService: 4,  dob: '1996-01-27', gender: 'Female', maritalStatus: 'Single'   },
  { id: 'M-06344', name: 'Thomas Brandt',    status: 'Retired',  agency: 'County of Santa Barbara',         tier: 'Tier 1',        yearsService: 33, dob: '1948-12-03', gender: 'Male',   maritalStatus: 'Married'  },
  { id: 'M-07019', name: 'Helen Nakamura',   status: 'Active',   agency: 'County of Santa Barbara',         tier: 'Tier 3',        yearsService: 9,  dob: '1982-08-19', gender: 'Female', maritalStatus: 'Married'  },
];
...
export const memberDetails = {
  'M-00847': {
    ...
    earnings: [
      // period, rawCode, gross, hours, leaveHours, payRate, payType, eligService, pensionableComp
      { period: 'Apr 1–14, 2026',  rawCode: 'REG',     gross: 5840, hours: 80, leaveHours: 0,  payRate: 73.00, payType: 'FTE',           eligService: 0.03846, pensionableComp: 5840 },
      { period: 'Mar 15–31, 2026', rawCode: 'REG',     gross: 5840, hours: 80, leaveHours: 0,  payRate: 73.00, payType: 'FTE',           eligService: 0.03846, pensionableComp: 5840 },
      { period: 'Mar 1–14, 2026',  rawCode: 'OT',      gross: 7020, hours: 92, leaveHours: 0,  payRate: 73.00, payType: 'FTE / OT',      eligService: 0.03846, pensionableComp: 5840 },
      { period: 'Feb 15–28, 2026', rawCode: 'REG',     gross: 5840, hours: 80, leaveHours: 0,  payRate: 73.00, payType: 'FTE',           eligService: 0.03846, pensionableComp: 5840 },
      { period: 'Feb 1–14, 2026',  rawCode: 'OT',      gross: 7020, hours: 92, leaveHours: 0,  payRate: 73.00, payType: 'FTE / OT',      eligService: 0.03846, pensionableComp: 5840 },
      { period: 'Jan 15–31, 2026', rawCode: 'REG',     gross: 5840, hours: 80, leaveHours: 0,  payRate: 73.00, payType: 'FTE',           eligService: 0.03846, pensionableComp: 5840 },
      { period: 'Jan 1–14, 2026',  rawCode: 'VACATION',gross: 5840, hours: 80, leaveHours: 80, payRate: 73.00, payType: 'FTE / VAC',     eligService: 0.03846, pensionableComp: 5840 },
      { period: 'Dec 15–31, 2025', rawCode: 'REG',     gross: 5840, hours: 80, leaveHours: 0,  payRate: 73.00, payType: 'FTE',           eligService: 0.03846, pensionableComp: 5840 },
      { period: 'Dec 1–14, 2025',  rawCode: 'REG',     gross: 5840, hours: 80, leaveHours: 0,  payRate: 73.00, payType: 'FTE',           eligService: 0.03846, pensionableComp: 5840 },
      { period: 'Nov 15–30, 2025', rawCode: 'REG',     gross: 5840, hours: 80, leaveHours: 0,  payRate: 73.00, payType: 'FTE',           eligService: 0.03846, pensionableComp: 5840 },
      { period: 'Nov 1–14, 2025',  rawCode: 'REG',     gross: 5840, hours: 80, leaveHours: 0,  payRate: 73.00, payType: 'FTE',           eligService: 0.03846, pensionableComp: 5840 },
      { period: 'Oct 15–31, 2025', rawCode: 'REG',     gross: 5840, hours: 80, leaveHours: 0,  payRate: 73.00, payType: 'FTE',           eligService: 0.03846, pensionableComp: 5840 },
      // Historical — legacy codes (visible in Full career view)
      { period: 'Jun 1–14, 2004',  rawCode: 'PTO20',   gross: 3200, hours: 80, leaveHours: 80, payRate: 40.00, payType: 'FTE / VAC',     eligService: 0.03846, pensionableComp: 3200 },
      { period: 'May 15–31, 2004', rawCode: 'REG',     gross: 3200, hours: 80, leaveHours: 0,  payRate: 40.00, payType: 'FTE',           eligService: 0.03846, pensionableComp: 3200 },
      { period: 'May 1–14, 2004',  rawCode: 'VAC-O',   gross: 1600, hours: 40, leaveHours: 40, payRate: 40.00, payType: 'VAC Payout',    eligService: 0.00000, pensionableComp: 0    },
      { period: 'Aug 1–14, 2003',  rawCode: 'MED-LV',  gross: 1800, hours: 40, leaveHours: 40, payRate: 40.00, payType: 'FTE / MED-LV',  eligService: 0.01923, pensionableComp: 1800 },
      { period: 'Jul 15–31, 2003', rawCode: 'MED-LV',  gross: 1800, hours: 40, leaveHours: 40, payRate: 40.00, payType: 'FTE / MED-LV',  eligService: 0.01923, pensionableComp: 1800 },
      { period: 'Jul 1–14, 2003',  rawCode: 'REG',     gross: 3200, hours: 80, leaveHours: 0,  payRate: 40.00, payType: 'FTE',           eligService: 0.03846, pensionableComp: 3200 },
    ],
    contributions: [
      { period: 'Apr 2026', rate: '9.00%', memberContrib: 1140, employerPickUp: 2787, amtOwed: 0,    colaRate: '2.30%', colaContrib: 292, interest: 0.00 },
      { period: 'Mar 2026', rate: '9.00%', memberContrib: 1140, employerPickUp: 2787, amtOwed: 0,    colaRate: '2.30%', colaContrib: 292, interest: 0.00 },
      { period: 'Feb 2026', rate: '9.00%', memberContrib: 1140, employerPickUp: 2787, amtOwed: 0,    colaRate: '2.30%', colaContrib: 292, interest: 0.00 },
      { period: 'Jan 2026', rate: '9.00%', memberContrib: 1140, employerPickUp: 2787, amtOwed: 0,    colaRate: '2.30%', colaContrib: 292, interest: 0.00 },
      { period: 'Dec 2025', rate: '9.00%', memberContrib: 1140, employerPickUp: 2787, amtOwed: 0,    colaRate: '2.30%', colaContrib: 292, interest: 0.00 },
      { period: 'Nov 2025', rate: '9.00%', memberContrib: 1140, employerPickUp: 2787, amtOwed: 0,    colaRate: '2.30%', colaContrib: 292, interest: 0.00 },
      { period: 'Oct 2025', rate: '9.00%', memberContrib: 1140, employerPickUp: 2787, amtOwed: 0,    colaRate: '2.30%', colaContrib: 292, interest: 0.00 },
      { period: 'Sep 2025', rate: '9.00%', memberContrib: 1140, employerPickUp: 2787, amtOwed: 0,    colaRate: '2.30%', colaContrib: 292, interest: 0.00 },
      { period: 'Aug 2025', rate: '9.00%', memberContrib: 1140, employerPickUp: 2787, amtOwed: 0,    colaRate: '2.30%', colaContrib: 292, interest: 0.00 },
      { period: 'Jul 2025', rate: '9.00%', memberContrib: 1140, employerPickUp: 2787, amtOwed: 0,    colaRate: '2.30%', colaContrib: 292, interest: 0.00 },
      { period: 'Jun 2025', rate: '9.00%', memberContrib: 1097, employerPickUp: 2681, amtOwed: 0,    colaRate: '2.30%', colaContrib: 281, interest: 0.00 },
      { period: 'May 2025', rate: '9.00%', memberContrib: 1097, employerPickUp: 2681, amtOwed: 114,  colaRate: '2.30%', colaContrib: 281, interest: 3.80 },
    ],
    transactions: [
      ...
      { date: 'Jan 1, 2025',  type: 'Interest Posting',   amount: '$1,067.10',  balance: '$281,200.00', notes: 'Quarterly interest credit' },
      { date: 'Oct 1, 2024',  type: 'COLA Adjustment',    amount: '+2.0%',      balance: '$278,900.00', notes: 'FY2025 COLA applied per Board resolution' },
      { date: 'Jul 1, 2024',  type: 'Interest Posting',   amount: '$1,034.80',  balance: '$274,600.00', notes: 'Quarterly interest credit' },
      { date: 'Apr 1, 2024',  type: 'Interest Posting',   amount: '$998.50',    balance: '$270,100.00', notes: 'Quarterly interest credit' },
      { date: 'Jan 1, 2024',  type: 'Interest Posting',   amount: '$961.20',    balance: '$266,400.00', notes: 'Quarterly interest credit' },
      { date: 'Oct 1, 2023',  type: 'COLA Adjustment',    amount: '+2.5%',      balance: '$263,800.00', notes: 'FY2024 COLA applied per Board resolution' },
      { date: 'Jul 1, 2023',  type: 'Interest Posting',   amount: '$924.40',    balance: '$258,200.00', notes: 'Quarterly interest credit' },
      { date: 'Apr 1, 2023',  type: 'Interest Posting',   amount: '$887.60',    balance: '$254,100.00', notes: 'Quarterly interest credit' },
      { date: 'Jan 1, 2023',  type: 'Interest Posting',   amount: '$851.30',    balance: '$250,400.00', notes: 'Quarterly interest credit' },
      { date: 'Oct 1, 2022',  type: 'COLA Adjustment',    amount: '+1.8%',      balance: '$247,600.00', notes: 'FY2023 COLA applied per Board resolution' },
      { date: 'Jul 1, 2022',  type: 'Interest Posting',   amount: '$816.90',    balance: '$243,200.00', notes: 'Quarterly interest credit' },
      ...
      { date: 'Dec 1, 2019',  type: 'Benefit Payment',    amount: '-$6,840.00', balance: '$264,680.00', notes: 'Monthly benefit payment — projected' },
      { date: 'Nov 1, 2019',  type: 'Benefit Payment',    amount: '-$6,840.00', balance: '$271,520.00', notes: 'Monthly benefit payment — projected' },
      { date: 'Oct 1, 2019',  type: 'COLA Adjustment',    amount: '+1.5%',      balance: '$278,360.00', notes: 'FY2020 COLA applied per Board resolution' },
    ],
    health: {
